  ...
  return (
    <>
      ...
      <div className="border-b border-dashed p-4">
        {/* <VoiceSelector /> */}Voice selector is currently disabled as we only
        have one voice available, but this will be added back in the future when
        we have more voices to choose from.
      </div>
